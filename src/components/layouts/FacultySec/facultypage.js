...
import {facultydata, contactinfo} from './facultydata';
...
state = {
    ...
    deptnames:["Commerce & Management",  "Computer Science", "Languages","Administrative","Library"],
    currentdept:"",
    dept:"",
    ph:"",
    email:"",
    ...
    render() {
        return (
            <FacultyWrap className="container " >
                ...
                if( faculty.commerce == (this.state.currentdept || 'Commerce & Management')){
